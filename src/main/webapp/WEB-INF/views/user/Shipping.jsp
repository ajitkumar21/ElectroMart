...
<div class="row">
	<div class="col-md-offset-3 col-md-6">
		...
		<div class="col-md-10 ">
			<input type="text" placeholder="" name="name" required="required" class="form-control" >
			<br>
		</div>
		</div>
		...
		<div class="col-md-10 ">
			<input type="password" placeholder="email_ID" name="email_ID" required="required"  class="form-control" />
			<br>
		</div>
		</div>
