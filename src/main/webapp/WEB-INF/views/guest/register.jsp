...
<div class="container">
<form:form action="${contextPath}/register" modelAttribute="UserDetails" method="post">
...
<div class="row">
	<div class="col-md-offset-2 col-md-8">
		...
		<h2 align="center" ><b><span style="color:#696969;">REGISTER</span></b></h2>
		</div>
	    ...
	    <div class="form-group">
		<label class="col-md-2 control-label"><span style="color:#696969;">ContactNumber:</span></label>
		<div class="col-md-10 ">
			<form:input type ="text" path ="contactNumber" required="required" class="form-control" />
		...
		<div class="col-md-10 ">
			<form:input type ="text" path ="email_Id" required="required" class="form-control" />
		...
		<div class="form-group">
		<label class="col-md-2 control-label"><span style="color:#696969;">ConfirmPassword:</span></label>
		<div class="col-md-10 ">
			<form:input type ="password" path ="confirmpassword" required="required" class="form-control" />
		...
		<div class="form-group" align="center">
			<button  type="submit"  class="btn btn-info btn-md" >S u b m i t</button>
